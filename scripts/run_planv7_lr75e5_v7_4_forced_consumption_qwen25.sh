...
BASE_SEED="${1:-61109}"
RUN_ROOT="${2:-/root/autodl-tmp/runs/verify/planv7-lr75e5-v7-4-forced-consumption-qwen25}"
RESULT_ROOT="${3:-/root/autodl-tmp/results/generated/planv7-lr75e5-v7-4-forced-consumption-qwen25}"
...
V73_SUMMARY_JSON="${7:-results/generated/review/planv7-lr75e5-v7-3-bridge-qwen25/v7-3-summary.json}"
...
exec bash scripts/run_planv7_v7_4_forced_consumption_qwen25.sh \
  "${BASE_SEED}" \
  "${RUN_ROOT}" \
  "${RESULT_ROOT}" \
  "${RESUME_STAGE_B_ROOT}" \
