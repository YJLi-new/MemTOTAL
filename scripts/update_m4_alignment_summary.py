...
from memtotal.analysis.m4_shared_injection import compare_m4_alignment_runs


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Summarize M4.7 canonical vs ablations alignment runs.")
