...
BASE_SEED="${1:-61109}"
RUN_ROOT="${2:-/root/autodl-tmp/runs/verify/planv7-lr75e5-v7-0-metrics-oracle-qwen25}"
RESULT_ROOT="${3:-/root/autodl-tmp/results/generated/planv7-lr75e5-v7-0-metrics-oracle-qwen25}"
...
exec bash scripts/run_planv7_v7_0_metrics_oracle_qwen25.sh \
  "${BASE_SEED}" \
  "${RUN_ROOT}" \
  "${RESULT_ROOT}" \
  "${RESUME_STAGE_B_ROOT}" \
