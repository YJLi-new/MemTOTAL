...
bash scripts/run_planv8_v8_1_reader_interface_scout.sh \
  "${1:-61109}" \
  "${2:-/root/autodl-tmp/runs/verify/planv8-v8-1-reader-interface-scout-qwen34}" \
  "${3:-/root/autodl-tmp/results/generated/planv8-v8-1-reader-interface-scout-qwen34}" \
