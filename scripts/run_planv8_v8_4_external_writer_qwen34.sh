...
bash scripts/run_planv8_v8_4_external_writer.sh \
  "${1:-61109}" \
  "${2:-/root/autodl-tmp/runs/verify/planv8-v8-4-external-writer-qwen34}" \
  "${3:-/root/autodl-tmp/results/generated/planv8-v8-4-external-writer-qwen34}" \
  "${4:-/root/autodl-tmp/models/Qwen3-4B}" \
  "${5:-/root/autodl-tmp/runs/verify/planv8-v8-3-reader-opd-qwen34}" \
  "${6:-results/generated/review/planv8-v8-3-reader-opd-qwen34/v8-3-summary.json}" \
  "${7:-results/generated/review/planv8-v8-3-reader-opd-qwen34/selected-prompt-modes.json}"
