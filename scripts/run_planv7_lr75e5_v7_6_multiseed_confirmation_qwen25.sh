...
BASE_SEED="${1:-61109}"
RUN_ROOT="${2:-/root/autodl-tmp/runs/verify/planv7-lr75e5-v7-6-multiseed-confirmation-qwen25}"
RESULT_ROOT="${3:-/root/autodl-tmp/results/generated/planv7-lr75e5-v7-6-multiseed-confirmation-qwen25}"
...
V75_SUMMARY_JSON="${7:-results/generated/review/planv7-lr75e5-v7-5-targeted-aux-revisit-qwen25/v7-5-summary.json}"
V70_SUMMARY_JSON="${8:-results/generated/review/planv7-lr75e5-v7-0-metrics-oracle-qwen25/v7-0-summary.json}"
...
exec bash scripts/run_planv7_v7_6_multiseed_confirmation_qwen25.sh \
  "${BASE_SEED}" \
  "${RUN_ROOT}" \
  "${RESULT_ROOT}" \
  "${RESUME_STAGE_B_ROOT}" \
