...
BASE_SEED="${1:-61109}"
V83_RESULT_ROOT="${2:-/root/autodl-tmp/results/generated/planv8-v8-3-reader-opd-qwen34}"
V87_RUN_ROOT="${3:-/root/autodl-tmp/runs/verify/planv8-v8-7-comparators-qwen34}"
V87_RESULT_ROOT="${4:-/root/autodl-tmp/results/generated/planv8-v8-7-comparators-qwen34}"
...
V76_SUMMARY_PATH="${8:-results/generated/review/planv7-lr75e5-v7-6-multiseed-confirmation-qwen25/v7-6-summary.json}"
RUN_SESSION="${9:-planv8_v87_q34}"
WATCH_SESSION="${10:-planv8_v87_q34_watch}"
POST_SESSION="${11:-planv8_v87_q34_post}"
...
if next_step != "open_v8_7_comparators":
    raise SystemExit(
        f"V8-3 did not authorize V8-7 on qwen34; recommended_next_step={next_step!r}"
    )
PY
