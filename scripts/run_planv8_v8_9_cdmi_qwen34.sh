...
bash scripts/run_planv8_v8_9_cdmi.sh \
  "${1:-61109}" \
  "${2:-/root/autodl-tmp/runs/verify/planv8-v8-9-cdmi-qwen34}" \
  "${3:-/root/autodl-tmp/results/generated/planv8-v8-9-cdmi-qwen34}" \
  ...
  "${7:-/root/autodl-tmp/results/generated/planv8-v8-8-multiseed-confirmation-qwen34}"
