...
bash scripts/run_planv8_v8_2_reader_sweep.sh \
  "${1:-61109}" \
  "${2:-/root/autodl-tmp/runs/verify/planv8-v8-2-reader-sweep-qwen34}" \
  "${3:-/root/autodl-tmp/results/generated/planv8-v8-2-reader-sweep-qwen34}" \
  "${4:-/root/autodl-tmp/models/Qwen3-4B}" \
  "${5:-results/generated/review/planv8-v8-0-qwen34-baselines-oracles/selected-prompt-modes.json}" \
  "${6:-results/generated/review/planv8-v8-1-reader-interface-scout-qwen34/v8-1-summary.json}"
