...
- Stage C：
  ...
  - `runtime.target_support_negative_sampler` 现支持 `deterministic_id / hard_by_continuation`；fresh 5-seed 对照显示 `hard_by_continuation` 还不足以稳定放大 official gain，因此当前 canonical 显式固定为 `deterministic_id`
