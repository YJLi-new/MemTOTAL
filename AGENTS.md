...
> Deeper knowledge should be written into and maintained in: `PLANv9.md`, `docs/MAIN_IDEA.md`, `docs/EXPERIMENTS_INFO.md`, `docs/exec-plans/`, and `docs/`.
> Historical predecessor evidence remains in `PLANv8.md`, but active execution authority now belongs to `PLANv9.md`.

---

## 0) One-Sentence TL;DR (always do this first)

**Before starting any new task on the next line of work, open `PLANv9.md` first and execute against it strictly.**

- `PLANv9.md`: single entry point for the next line of work / upcoming execution plan / DoD / artifact requirements / milestone order
...
> 3. If documents conflict: **method authority belongs to `docs/MAIN_IDEA.md`; experiment authority belongs to `docs/EXPERIMENTS_INFO.md`; execution order and acceptance for the next line of work belong to `PLANv9.md`.**

---

## 1) Document Responsibilities (separate responsibilities before doing work)

### `PLANv9.md` - the authoritative runbook / backlog for the next line of work
Every new task on the `PLANv9` line starts here. It defines:
- milestone order
- P0/P1/P2 priorities
...
- `PLANv9.md`: task breakdown, DoD, priorities, runbook
...
1. **Ask / Understand**
   First locate the relevant upcoming milestone, item, and DoD in `PLANv9.md`.
...
6. **PR / Deliver**
   ...
   - which `PLANv9.md` item was completed
   - which files changed
...
- maintain the golden principles / quality tracker / tech-debt tracker in `docs/` when `PLANv9.md` requires it
...
## 6) Minimum Repo and Artifact Contract (details defer to `PLANv9.md`)
...
1. **Completed work**: the corresponding `PLANv9.md` item and a short explanation
